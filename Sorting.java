...
public class Sorting implements Comparator<save_in_mem> {
    ...
    @Override
		public int compare(save_in_mem arg0, save_in_mem arg1) {
			...
			if(arg0.getdstport() > arg1.getdstport())
				return 1 ;
			else if(arg0.getdstport() < arg1.getdstport())	
				return -1 ;
			else 
				return 0;
		}
...
/*	class Sortebylength implements Comparator<save_in_mem>{
	...
	class SortbysourceIP implements Comparator<save_in_mem>{
